...
public interface TeacherRepository extends JpaRepository<Teacher, Long> {
	...
	@Query("SELECT new com.lms.dtos.teacher.AddTeacherRequest(t.id,t.firstName,t.lastName,t.email,t.address,t.gender,t.joinedDate,t.profileImage,t.departmentName) FROM Teacher t")
