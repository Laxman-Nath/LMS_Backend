...
public interface StudentRepository extends JpaRepository<Student, Long> {
	...
	@Query("SELECT new com.lms.dtos.student.AddStudentRequest(s.id,s.firstName,s.lastName,s.email,s.address,s.gender,s.joinedDate,s.rollNo,s.year,s.semester,s.profileImage,s.departmentName) FROM Student s")
